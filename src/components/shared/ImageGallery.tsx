...
export interface ImageGalleryProps {
  ...
  /** Aspect ratio class for the image container. Defaults to "aspect-[2/1]". */
  aspectRatio?: string
  /** Show "Primary" badge on the first image. Defaults to true. */
  showPrimaryBadge?: boolean
  /** Show reorder buttons. Defaults to true. */
  showReorder?: boolean
}
          ...
          >
            ...
            {showReorder && (onMoveUp || onMoveDown) && (
              <div className="absolute bottom-1 right-1 flex gap-0.5 opacity-0 transition-opacity group-hover:opacity-100">
                ...
                {index < images.length - 1 && onMoveDown && (
                  <button
                    type="button"
